...
output representation. Changed inputs conflict before storage/network work. Prune's schema-1 IPC request has no `cutoff_ms`: after the first
...
{"type":"download_complete","schema_version":2,"operation_id":"0123456789abcdef0123456789abcdef","token_digest":"<64-lowercase-hex>","offer_id":"<id>","kind":"file","name":"report.pdf","size":1234,"from":"<peer-id>","output":"./received-report.pdf","mode":"install","installed":true,"pinned":true,"destination_synced":true,"cleanup_complete":true,"warnings":[]}
```
