...
| `POST /api/attachment` | Stream one file as unencoded `application/octet-stream`; its percent-encoded portable filename is supplied in `X-Meshmsg-File-Name` |
